...
这是 **Estun Robotics** 提供的实时控制接口 (ERI) 开发工具包。本 SDK 旨在为全球开发者提供稳定、高性能的机器人运动控制支持。
...
### 2. 下载二进制库
由于合规性与仓库体积限制，请前往 [Releases](https://github.com/Mr-sail/estun_eri_sdk/releases) 页面下载对应系统的二进制压缩包，并解压至项目根目录。
